...
from polyaxon_deploy.proxies.schemas.base import clean_config, get_config
from polyaxon_deploy.proxies.schemas.urls import (
    get_header_host,
    get_service_url,
    get_ssl_server_name,
)
from polyaxon_schemas.api import (
    ADMIN_V1_LOCATION,
    API_V1_LOCATION,
    SSO_V1_LOCATION,
    UI_V1_LOCATION,
